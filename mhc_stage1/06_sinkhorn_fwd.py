...
def gpu_mhc_sinkhorn_fwd(
    ...
    return gpu_mhc_sinkhorn_kernel
...
if __name__ == "__main__":
    ...
    # program = mhc_sinkhorn_fwd(hidden_size, token_block_size, repeat, eps)
    ...
    gpu_program = gpu_mhc_sinkhorn_fwd(hidden_size, token_block_size, repeat, eps)
